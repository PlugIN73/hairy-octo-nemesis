function DeviceS125(node, width, height) {
  ...
  this.state = {
    power: 0, inversion: 0, earthA: 0, closedA: 0, earthA: 0,
    p: [], vertical_offset: 0,
    def: {}
  };
...
DeviceS125.prototype.definitionControl = function () {
  ...
  c.push({key: 'earthA', cls: Button, param: 'd.earthA = 1; d.closedA = 0;'});
	c.push({key: 'closedA', cls: Button, param: 'd.closedA = 1; d.earthA = 0;'});
